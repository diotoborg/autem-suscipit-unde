# [BahtRext](https://pinghuskar.github.io/npm-@diotoborg/autem-suscipit-unde/)
![Download/month](https://img.shields.io/npm/dm/@diotoborg/autem-suscipit-unde.svg)
![Total Download](https://img.shields.io/npm/dt/@diotoborg/autem-suscipit-unde.svg)
...
- **`101`** ควรจะถูกอ่านอย่างไร ?
  ...
  - `หนึ่งร้อยหนึ่งบาทถ้วน` หรือ `หนึ่งร้อยเอ็ดบาทถ้วน` ก็ได้ ให้เข้าใจได้ตรงกัน
    - [**`BahtRext`**](https://pinghuskar.github.io/npm-@diotoborg/autem-suscipit-unde/)
      - [Versions](https://www.npmjs.com/package/@diotoborg/autem-suscipit-unde?activeTab=versions)
      - [REPO](https://github.com/diotoborg/autem-suscipit-unde)
...
## 😊 Plz Consider
- [Give A Star](https://github.com/diotoborg/autem-suscipit-unde)
- Write a Review
- Submit Test Case(s)
